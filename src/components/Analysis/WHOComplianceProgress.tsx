...
export const WHOComplianceProgress = ({
  dataPoints,
}: WHOComplianceProgressProps) => {
  const { t } = useTranslation();

  const compliancePercentage =
    dataPoints.totalExposureMinutes > 0
      ? ((dataPoints.totalExposureMinutes - dataPoints.timeAboveWHO) /
          dataPoints.totalExposureMinutes) *
        100
      : 0;
