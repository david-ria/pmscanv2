      ...
      <CardContent className="p-4">
        ...
        <div className="grid grid-cols-2 gap-3 text-xs">
          <div className="flex items-center gap-2">
            <Wifi
              className={`h-3 w-3 ${backgroundSyncSupported ? 'text-green-500' : 'text-red-500'}`}
            />
            <span
              className={
                backgroundSyncSupported ? 'text-green-700' : 'text-red-700'
              }
            >
              Background Sync
            </span>
          ...
          <div className="flex items-center gap-2">
            <Bell
              className={`h-3 w-3 ${notificationPermission === 'granted' ? 'text-green-500' : 'text-amber-500'}`}
            />
            <span
              className={
          ...
          <div className="flex items-center gap-2">
            <BatteryLow
              className={`h-3 w-3 ${wakeLock ? 'text-green-500' : 'text-amber-500'}`}
            />
