...
export function useMenuSections({
  ...
  const handleBackgroundRecordingToggle = async (enabled: boolean) => {
    if (enabled) {
      await enableRecordingBackground('30s');
    } else {
    ...
    },
    {
      ...
      items: [
        ...
        { icon: Languages, label: t('settingsMenu.language'), badge: getCurrentLanguageDisplay() },
        {
          ...
          badge: null,
          toggle: { checked: theme === 'dark', onCheckedChange: (checked) => setTheme(checked ? 'dark' : 'light') },
        },
        {
          icon: Moon,
          label: 'Background Recording',
          badge: null,
          toggle: { checked: isBackgroundEnabled, onCheckedChange: handleBackgroundRecordingToggle },
        ...
        },
        {
          ...
          label: 'Auto Context',
          badge: null,
          toggle: { checked: autoContextEnabled, onCheckedChange: toggleAutoContext },
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          action: () => setSensorType(sensorType === 'airBeam' ? 'pmScan' : 'airBeam'),
        },
        {
          icon: MapPin,
          label: 'GPS',
        ...
        },
        {
          ...
          badge: null,
          toggle: { checked: weatherLoggingEnabled, onCheckedChange: setWeatherLoggingEnabled },
        },
      ],
    },
  ];
